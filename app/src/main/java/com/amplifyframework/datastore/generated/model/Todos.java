...
public final class Todos implements Model {
  ...
  private Todos(String id, String name, Priority priority, String description) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), todos.getId()) &&
              ObjectsCompat.equals(getName(), todos.getName()) &&
              ObjectsCompat.equals(getPriority(), todos.getPriority()) &&
              ObjectsCompat.equals(getDescription(), todos.getDescription());
      }
  }
   ...
   */
  public static Todos justId(String id) {
    try {
